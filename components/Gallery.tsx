          ...
          <div className="pt-[300px] md:pt-96 pb-[550px] ">
            ...
            {sortedGalleryItems.map((item) => (
              <div className="flex flex-col z-4 lg:flex-col mx-auto  lg:mx-5 mt-10 mb-[200px]">
                ...
                <div className="w-5/6  mx-auto z-1 lg:w-5/6 border-b backdrop-blur-xl text-slate-200 bg-opacity-30  flex lg:hidden  lg:flex-row  p-5 justify-center rounded-br-2xl rounded-bl-2xl  lg:rounded-xl relative -top-0 shadow-md">

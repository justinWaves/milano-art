  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto pt-40 mb-20 p-12">
        ...
        <p>
          At Matt Milano Art, accessible from https://mattmilanoart.com/, one of
          our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by Matt Milano Art and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in Matt Milano Art. This policy is not
        ...
        <p>
          Matt Milano Art follows a standard procedure of using log files. These
        ...
        <p>
          ...
          advertising partners of Matt Milano Art.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Matt Milano Art, which are
        ...
        <p>
          Note that Matt Milano Art has no access to or control over these
        ...
        <p>
          Matt Milano Art's Privacy Policy does not apply to other advertisers
        ...
        <p>
          Matt Milano Art does not knowingly collect any Personal Identifiable
